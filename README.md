...
- [estahn/k8s-image-swapper](https://github.com/estahn/k8s-image-swapper) ([v1.5.23](https://github.com/estahn/k8s-image-swapper/releases/tag/v1.5.23), today) - Mirror images into your own registry and swap image references automatically.
