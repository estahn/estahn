...
- [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) ([v7.0.3](https://github.com/amplify-education/serverless-domain-manager/releases/tag/v7.0.3), 3 days ago) - Serverless plugin for managing custom domains with API Gateways.
