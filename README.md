...
- [backstage/backstage](https://github.com/backstage/backstage) ([v0.70.0](https://github.com/backstage/backstage/releases/tag/v0.70.0), today) - Backstage is an open platform for building developer portals
