...
- [estahn/cloudping](https://github.com/estahn/cloudping) ([v1.2.39](https://github.com/estahn/cloudping/releases/tag/v1.2.39), 1 day ago) - Identifies geographically closest cloud provider region
- [estahn/charts](https://github.com/estahn/charts) ([k8s-image-swapper-0.2.7](https://github.com/estahn/charts/releases/tag/k8s-image-swapper-0.2.7), 5 days ago) - estahn&#39;s Helm Chart Repository
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([cluster-autoscaler-chart-9.9.2](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.9.2), 3 weeks ago) - Autoscaling components for Kubernetes
