...
- [gruntwork-io/terratest](https://github.com/gruntwork-io/terratest) ([v0.40.1](https://github.com/gruntwork-io/terratest/releases/tag/v0.40.1), 3 days ago) -  Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
- [backstage/backstage](https://github.com/backstage/backstage) ([v0.67.0](https://github.com/backstage/backstage/releases/tag/v0.67.0), 5 days ago) - Backstage is an open platform for building developer portals
