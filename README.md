...
- [hipagesgroup/actions](https://github.com/hipagesgroup/actions) ([v2.0](https://github.com/hipagesgroup/actions/releases/tag/v2.0), 2 days ago) - GitHub Actions - Automate your GitHub workflows
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.1.0-next.0](https://github.com/backstage/backstage/releases/tag/v1.1.0-next.0), 2 days ago) - Backstage is an open platform for building developer portals
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.24.0-alpha.3](https://github.com/kubernetes/kops/releases/tag/v1.24.0-alpha.3), 5 days ago) - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
