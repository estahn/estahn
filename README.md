...
- [estahn/json-query-wrapper](https://github.com/estahn/json-query-wrapper) - A wrapper for the popular command-line JSON processor &#34;jq&#34; (5 days ago)
...
- [runatlantis/helm-charts](https://github.com/runatlantis/helm-charts) ([atlantis-3.12.9](https://github.com/runatlantis/helm-charts/releases/tag/atlantis-3.12.9), 4 days ago) - Atlantis Helm Chart
- [estahn/json-query-wrapper](https://github.com/estahn/json-query-wrapper) ([v1.0.0](https://github.com/estahn/json-query-wrapper/releases/tag/v1.0.0), 6 days ago) - A wrapper for the popular command-line JSON processor &#34;jq&#34;
...
- [skeema/skeema](https://github.com/skeema/skeema) ([v1.4.7](https://github.com/skeema/skeema/releases/tag/v1.4.7), 1 week ago) - Schema management CLI for MySQL
- [estahn/charts](https://github.com/estahn/charts) ([k8s-image-swapper-0.2.5](https://github.com/estahn/charts/releases/tag/k8s-image-swapper-0.2.5), 1 week ago) - estahn&#39;s Helm Chart Repository
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([cluster-autoscaler-chart-9.3.1](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.3.1), 2 weeks ago) - Autoscaling components for Kubernetes
...
- [Export AWS Route53 Domains as CSV for Excel people](https://enricostahn.com/post/export-route53-domains-to-csv/) (1 week ago)
- [Kubernetes Secrets in plain-text](https://enricostahn.com/post/kubernetes-secrets-in-plaintext/) (1 week ago)
