...
- [hipagesgroup/argocd-app-updater-action](https://github.com/hipagesgroup/argocd-app-updater-action) -  (5 months ago)
...
- [estahn/cloudping](https://github.com/estahn/cloudping) ([v1.2.54](https://github.com/estahn/cloudping/releases/tag/v1.2.54), 2 days ago) - Identifies geographically closest cloud provider region
- [humio/humio-operator](https://github.com/humio/humio-operator) ([humio-operator-0.8.0](https://github.com/humio/humio-operator/releases/tag/humio-operator-0.8.0), 4 days ago) - Kubernetes Operator for Humio
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([addon-resizer-1.8.13](https://github.com/kubernetes/autoscaler/releases/tag/addon-resizer-1.8.13), 1 week ago) - Autoscaling components for Kubernetes
...
- [skeema/skeema](https://github.com/skeema/skeema) ([v1.5.1](https://github.com/skeema/skeema/releases/tag/v1.5.1), 3 weeks ago) - Schema management CLI for MySQL
- [runatlantis/helm-charts](https://github.com/runatlantis/helm-charts) ([atlantis-3.12.13](https://github.com/runatlantis/helm-charts/releases/tag/atlantis-3.12.13), 1 month ago) - Atlantis Helm Chart
- [kubesphere/fluentbit-operator](https://github.com/kubesphere/fluentbit-operator) ([v0.5.0](https://github.com/kubesphere/fluentbit-operator/releases/tag/v0.5.0), 1 month ago) - Fluent-Bit operator for Kubernetes
