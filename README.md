...
- [terraform-aws-modules/terraform-aws-rds-aurora](https://github.com/terraform-aws-modules/terraform-aws-rds-aurora) ([v8.2.0](https://github.com/terraform-aws-modules/terraform-aws-rds-aurora/releases/tag/v8.2.0), 5 days ago) - Terraform module which creates RDS Aurora resources on AWS 🇺🇦
...
- [estahn/cloudping](https://github.com/estahn/cloudping) ([v1.2.147](https://github.com/estahn/cloudping/releases/tag/v1.2.147), 4 weeks ago) - Identifies geographically closest cloud provider region
