...
- [gruntwork-io/terratest](https://github.com/gruntwork-io/terratest) ([v0.40.15](https://github.com/gruntwork-io/terratest/releases/tag/v0.40.15), 1 day ago) -  Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.24.0-beta.1](https://github.com/kubernetes/kops/releases/tag/v1.24.0-beta.1), 2 days ago) - Kubernetes Operations (kOps) - Production Grade k8s Installation, Upgrades and Management
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.3.0-next.1](https://github.com/backstage/backstage/releases/tag/v1.3.0-next.1), 1 week ago) - Backstage is an open platform for building developer portals
