...
- [arabold/serverless-export-env](https://github.com/arabold/serverless-export-env) - Serverless plugin to export environment variables into a .env file (6 days ago)
...
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.4.0-next.0](https://github.com/backstage/backstage/releases/tag/v1.4.0-next.0), 1 day ago) - Backstage is an open platform for building developer portals
- [arabold/serverless-export-env](https://github.com/arabold/serverless-export-env) ([v2.2.0](https://github.com/arabold/serverless-export-env/releases/tag/v2.2.0), 6 days ago) - Serverless plugin to export environment variables into a .env file
