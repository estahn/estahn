...
- [terraform-aws-modules/terraform-aws-rds-aurora](https://github.com/terraform-aws-modules/terraform-aws-rds-aurora) ([v9.3.1](https://github.com/terraform-aws-modules/terraform-aws-rds-aurora/releases/tag/v9.3.1), 4 days ago) - Terraform module to create AWS RDS Aurora resources 🇺🇦
- [estahn/k8s-image-swapper](https://github.com/estahn/k8s-image-swapper) ([v1.5.11](https://github.com/estahn/k8s-image-swapper/releases/tag/v1.5.11), 4 weeks ago) - Mirror images into your own registry and swap image references automatically.
