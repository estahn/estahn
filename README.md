...
- [gruntwork-io/terratest](https://github.com/gruntwork-io/terratest) ([v0.39.0](https://github.com/gruntwork-io/terratest/releases/tag/v0.39.0), 4 days ago) -  Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
- [backstage/backstage](https://github.com/backstage/backstage) ([v0.65.1](https://github.com/backstage/backstage/releases/tag/v0.65.1), 4 days ago) - Backstage is an open platform for building developer portals
