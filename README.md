...
- [estahn/k8s-image-swapper](https://github.com/estahn/k8s-image-swapper) ([v1.5.21](https://github.com/estahn/k8s-image-swapper/releases/tag/v1.5.21), today) - Mirror images into your own registry and swap image references automatically.
