...
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.6.0-next.1](https://github.com/backstage/backstage/releases/tag/v1.6.0-next.1), 1 day ago) - Backstage is an open platform for building developer portals
...
- [estahn/k8s-image-swapper](https://github.com/estahn/k8s-image-swapper) ([v1.2.2](https://github.com/estahn/k8s-image-swapper/releases/tag/v1.2.2), 1 month ago) - :wheel_of_dharma: Mirror images into your own registry and swap image references automatically.
