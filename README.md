...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.23.0](https://github.com/kubernetes/kops/releases/tag/v1.23.0), 2 days ago) - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
- [gruntwork-io/terratest](https://github.com/gruntwork-io/terratest) ([v0.40.6](https://github.com/gruntwork-io/terratest/releases/tag/v0.40.6), 4 days ago) -  Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
- [backstage/backstage](https://github.com/backstage/backstage) ([v0.70.1](https://github.com/backstage/backstage/releases/tag/v0.70.1), 4 days ago) - Backstage is an open platform for building developer portals
