...
- [estahn/k8s-image-swapper](https://github.com/estahn/k8s-image-swapper) ([v1.5.26](https://github.com/estahn/k8s-image-swapper/releases/tag/v1.5.26), today) - Mirror images into your own registry and swap image references automatically.
