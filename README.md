...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.22.3](https://github.com/kubernetes/kops/releases/tag/v1.22.3), 4 days ago) - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
- [backstage/backstage](https://github.com/backstage/backstage) ([release-2022-01-04](https://github.com/backstage/backstage/releases/tag/release-2022-01-04), 1 week ago) - Backstage is an open platform for building developer portals
- [hipagesgroup/actions](https://github.com/hipagesgroup/actions) ([legacy](https://github.com/hipagesgroup/actions/releases/tag/legacy), 4 weeks ago) - GitHub Actions - Automate your GitHub workflows
