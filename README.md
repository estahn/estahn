...
- [hipagesgroup/actions](https://github.com/hipagesgroup/actions) - GitHub Actions - Automate your GitHub workflows (6 months ago)
...
- [estahn/json-query-wrapper](https://github.com/estahn/json-query-wrapper) - A wrapper for the popular command-line JSON processor &#34;jq&#34; (9 months ago)
...
- [humio/humio-operator](https://github.com/humio/humio-operator) ([humio-operator-0.12.0](https://github.com/humio/humio-operator/releases/tag/humio-operator-0.12.0), 1 day ago) - Kubernetes Operator for Humio
- [backstage/backstage](https://github.com/backstage/backstage) ([release-2021-10-11](https://github.com/backstage/backstage/releases/tag/release-2021-10-11), 1 day ago) - Backstage is an open platform for building developer portals
- [estahn/charts](https://github.com/estahn/charts) ([k8s-image-swapper-0.3.2](https://github.com/estahn/charts/releases/tag/k8s-image-swapper-0.3.2), 6 days ago) - estahn&#39;s Helm Chart Repository
- [estahn/k8s-image-swapper](https://github.com/estahn/k8s-image-swapper) ([v1.1.0](https://github.com/estahn/k8s-image-swapper/releases/tag/v1.1.0), 1 week ago) - :wheel_of_dharma: Mirror images into your own registry and swap image references automatically.
...
- [runatlantis/helm-charts](https://github.com/runatlantis/helm-charts) ([atlantis-3.14.2](https://github.com/runatlantis/helm-charts/releases/tag/atlantis-3.14.2), 3 weeks ago) - Atlantis Helm Chart
- [fluent/fluentbit-operator](https://github.com/fluent/fluentbit-operator) ([v0.12.0](https://github.com/fluent/fluentbit-operator/releases/tag/v0.12.0), 4 weeks ago) - Fluent Bit operator for Kubernetes
