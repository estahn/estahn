...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.23.0-beta.1](https://github.com/kubernetes/kops/releases/tag/v1.23.0-beta.1), 1 day ago) - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
- [gruntwork-io/terratest](https://github.com/gruntwork-io/terratest) ([v0.38.8](https://github.com/gruntwork-io/terratest/releases/tag/v0.38.8), 2 days ago) -  Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
- [backstage/backstage](https://github.com/backstage/backstage) ([release-2021-12-10](https://github.com/backstage/backstage/releases/tag/release-2021-12-10), 2 days ago) - Backstage is an open platform for building developer portals
