...
- [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) ([v6.4.1](https://github.com/amplify-education/serverless-domain-manager/releases/tag/v6.4.1), 3 days ago) - Serverless plugin for managing custom domains with API Gateways.
