...
- [estahn/cloudping](https://github.com/estahn/cloudping) ([v1.2.135](https://github.com/estahn/cloudping/releases/tag/v1.2.135), 3 days ago) - Identifies geographically closest cloud provider region
- [backstage/backstage](https://github.com/backstage/backstage) ([release-2021-09-17](https://github.com/backstage/backstage/releases/tag/release-2021-09-17), 3 days ago) - Backstage is an open platform for building developer portals
- [runatlantis/helm-charts](https://github.com/runatlantis/helm-charts) ([atlantis-3.14.2](https://github.com/runatlantis/helm-charts/releases/tag/atlantis-3.14.2), 4 days ago) - Atlantis Helm Chart
- [humio/humio-operator](https://github.com/humio/humio-operator) ([humio-operator-0.11.0](https://github.com/humio/humio-operator/releases/tag/humio-operator-0.11.0), 6 days ago) - Kubernetes Operator for Humio
