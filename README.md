...
- [gruntwork-io/terratest](https://github.com/gruntwork-io/terratest) ([v0.40.20](https://github.com/gruntwork-io/terratest/releases/tag/v0.40.20), 1 day ago) -  Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.5.0-next.3](https://github.com/backstage/backstage/releases/tag/v1.5.0-next.3), 6 days ago) - Backstage is an open platform for building developer portals
