...
- [gruntwork-io/terratest](https://github.com/gruntwork-io/terratest) ([v0.40.5](https://github.com/gruntwork-io/terratest/releases/tag/v0.40.5), 1 day ago) -  Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
- [backstage/backstage](https://github.com/backstage/backstage) ([v0.69.2](https://github.com/backstage/backstage/releases/tag/v0.69.2), 4 days ago) - Backstage is an open platform for building developer portals
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.23.0-beta.2](https://github.com/kubernetes/kops/releases/tag/v1.23.0-beta.2), 5 days ago) - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
