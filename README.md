...
- [estahn/k8s-image-swapper](https://github.com/estahn/k8s-image-swapper) ([v1.5.16](https://github.com/estahn/k8s-image-swapper/releases/tag/v1.5.16), 3 days ago) - Mirror images into your own registry and swap image references automatically.
- [jazzband/dj-database-url](https://github.com/jazzband/dj-database-url) ([v2.2.0](https://github.com/jazzband/dj-database-url/releases/tag/v2.2.0), 2 months ago) - Use Database URLs in your Django Application.
