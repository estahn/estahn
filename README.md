...
- [gruntwork-io/terratest](https://github.com/gruntwork-io/terratest) ([v0.40.12](https://github.com/gruntwork-io/terratest/releases/tag/v0.40.12), 1 day ago) -  Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.3.0-next.0](https://github.com/backstage/backstage/releases/tag/v1.3.0-next.0), 6 days ago) - Backstage is an open platform for building developer portals
