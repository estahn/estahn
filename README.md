...
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.0.1](https://github.com/backstage/backstage/releases/tag/v1.0.1), 1 day ago) - Backstage is an open platform for building developer portals
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.24.0-alpha.3](https://github.com/kubernetes/kops/releases/tag/v1.24.0-alpha.3), 3 days ago) - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
