...
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.0.0](https://github.com/backstage/backstage/releases/tag/v1.0.0), 2 days ago) - Backstage is an open platform for building developer portals
