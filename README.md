...
- [iandees/aws-billing-to-slack](https://github.com/iandees/aws-billing-to-slack) - Send a daily AWS cost report to a Slack channel of your choice. (2 weeks ago)
...
- [estahn/cloudping](https://github.com/estahn/cloudping) ([v1.2.21](https://github.com/estahn/cloudping/releases/tag/v1.2.21), 2 days ago) - Identifies geographically closest cloud provider region
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([cluster-autoscaler-chart-9.9.0](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.9.0), 5 days ago) - Autoscaling components for Kubernetes
- [humio/humio-operator](https://github.com/humio/humio-operator) ([humio-operator-0.6.1](https://github.com/humio/humio-operator/releases/tag/humio-operator-0.6.1), 5 days ago) - Kubernetes Operator for Humio
