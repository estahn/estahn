...
- [amplify-education/serverless-domain-manager](https://github.com/amplify-education/serverless-domain-manager) ([v6.4.4](https://github.com/amplify-education/serverless-domain-manager/releases/tag/v6.4.4), 4 days ago) - Serverless plugin for managing custom domains with API Gateways.
...
- [estahn/cloudping](https://github.com/estahn/cloudping) ([v1.2.144](https://github.com/estahn/cloudping/releases/tag/v1.2.144), 3 weeks ago) - Identifies geographically closest cloud provider region
