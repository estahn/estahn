...
- [estahn/cloudping](https://github.com/estahn/cloudping) ([v1.2.27](https://github.com/estahn/cloudping/releases/tag/v1.2.27), today) - Identifies geographically closest cloud provider region
- [kubernetes/autoscaler](https://github.com/kubernetes/autoscaler) ([cluster-autoscaler-chart-9.9.2](https://github.com/kubernetes/autoscaler/releases/tag/cluster-autoscaler-chart-9.9.2), 3 days ago) - Autoscaling components for Kubernetes
