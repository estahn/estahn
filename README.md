...
- [estahn/k8s-image-swapper](https://github.com/estahn/k8s-image-swapper) ([v1.5.12](https://github.com/estahn/k8s-image-swapper/releases/tag/v1.5.12), today) - Mirror images into your own registry and swap image references automatically.
- [terraform-aws-modules/terraform-aws-rds-aurora](https://github.com/terraform-aws-modules/terraform-aws-rds-aurora) ([v9.3.1](https://github.com/terraform-aws-modules/terraform-aws-rds-aurora/releases/tag/v9.3.1), 6 days ago) - Terraform module to create AWS RDS Aurora resources 🇺🇦
