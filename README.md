...
- [estahn/cloudping](https://github.com/estahn/cloudping) ([v1.2.127](https://github.com/estahn/cloudping/releases/tag/v1.2.127), 1 day ago) - Identifies geographically closest cloud provider region
- [backstage/backstage](https://github.com/backstage/backstage) ([release-2021-09-02](https://github.com/backstage/backstage/releases/tag/release-2021-09-02), 2 days ago) - Backstage is an open platform for building developer portals
- [fluent/fluentbit-operator](https://github.com/fluent/fluentbit-operator) ([v0.11.0](https://github.com/fluent/fluentbit-operator/releases/tag/v0.11.0), 3 days ago) - Fluent Bit operator for Kubernetes
