...
- [backstage/backstage](https://github.com/backstage/backstage) ([release-2021-11-12](https://github.com/backstage/backstage/releases/tag/release-2021-11-12), 2 days ago) - Backstage is an open platform for building developer portals
- [hipages/php-fpm_exporter](https://github.com/hipages/php-fpm_exporter) ([v2.0.4](https://github.com/hipages/php-fpm_exporter/releases/tag/v2.0.4), 1 week ago) - A prometheus exporter for PHP-FPM.
...
- [kubernetes/kops](https://github.com/kubernetes/kops) ([v1.23.0-alpha.2](https://github.com/kubernetes/kops/releases/tag/v1.23.0-alpha.2), 1 week ago) - Kubernetes Operations (kops) - Production Grade K8s Installation, Upgrades, and Management
- [runatlantis/helm-charts](https://github.com/runatlantis/helm-charts) ([atlantis-3.14.3](https://github.com/runatlantis/helm-charts/releases/tag/atlantis-3.14.3), 2 weeks ago) - Atlantis Helm Chart
