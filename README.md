...
- [gruntwork-io/terratest](https://github.com/gruntwork-io/terratest) ([v0.40.3](https://github.com/gruntwork-io/terratest/releases/tag/v0.40.3), 1 day ago) -  Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
- [backstage/backstage](https://github.com/backstage/backstage) ([v0.68.1](https://github.com/backstage/backstage/releases/tag/v0.68.1), 2 days ago) - Backstage is an open platform for building developer portals
